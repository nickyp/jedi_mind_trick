...
public class LukeSkyWalker extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("LukeSkyWalker");
        metaclass.setRubyStaticAllocator(LukeSkyWalker.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: LukeSkyWalker");
     ...
     */
    private LukeSkyWalker(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new LukeSkyWalker(ruby, metaClass);
    }
